...
function render(){
  ...
  visible.forEach((e) => {
    ...
    tr.innerHTML = `
      ...
      <td><span class="readCell amount">${e.chf === "" || e.chf == null ? "" : escapeHtml(formatNumber(e.chf))}</span></td>
      <td><span class="readCell amount">${e.eur === "" || e.eur == null ? "" : escapeHtml(formatNumber(e.eur))}</span></td>
